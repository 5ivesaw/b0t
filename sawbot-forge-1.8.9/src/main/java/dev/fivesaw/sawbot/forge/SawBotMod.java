...
public final class SawBotMod {
    ...
    public static final String VERSION = "0.9.0-alpha.0";
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        logger.info("SawBotV1 Phase 8 bridging specialist initialized; autonomous control is disabled by default.");
    }
    ...
    public void init(FMLInitializationEvent event) {
        ...
        logger.info("SawBotV1 Phase 8 event handlers registered.");
    }
}
