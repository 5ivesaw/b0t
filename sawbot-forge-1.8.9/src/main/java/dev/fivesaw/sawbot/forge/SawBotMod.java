...
public final class SawBotMod {
    ...
    public static final String VERSION = "0.7.0-alpha.0";
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        logger.info("SawBotV1 Phase 6 hybrid navigation initialized; autonomous control is disabled by default.");
    }
    ...
    public void init(FMLInitializationEvent event) {
        ...
        logger.info("SawBotV1 Phase 6 event handlers registered.");
    }
}
