...
REQUIRED_ENTRIES = {
    ...
    "dev/fivesaw/sawbot/common/navigation/NavigationMovement.class",
    "dev/fivesaw/sawbot/common/navigation/NavigationMovementType.class",
    "dev/fivesaw/sawbot/common/navigation/NavigationProgressWatchdog.class",
    "dev/fivesaw/sawbot/common/navigation/PathSegmentCoordinator.class",
    "dev/fivesaw/sawbot/forge/navigation/WorldNavigationGrid.class",
    "dev/fivesaw/sawbot/forge/navigation/NavigationPlannerWorker.class",
    "dev/fivesaw/sawbot/forge/navigation/NavigationSnapshotCapture.class",
    "dev/fivesaw/sawbot/forge/navigation/NavigationCameraController.class",
    "dev/fivesaw/sawbot/forge/navigation/NavigationMovementExecutor.class",
